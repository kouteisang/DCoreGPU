#include "observation1.cuh"
#include "gpuutilis.cuh"

__device__ int warp_reduce_sum_balance_buffer_obs1(int val) {
    for (int offset = 16; offset > 0; offset /= 2)
        val += __shfl_down_sync(0xffffffff, val, offset);
    return val;
}

__global__ void update_upper_by_out_buffer_s_obs1(int* out_buffer_s, int* count_out_s, int* hindex_in, int* hindex_out, int* core, int* newvisit){
    __shared__ int end;
    ...
    for(int id = threadIdx.x; id < end; id += BLK_DIM){
        ...
        if(newvisit[v] == 0) continue;
        // printf("%d, %d\n", hindex_in[v], hindex_out[v]);
        core[v] = min(hindex_in[v], hindex_out[v]);
    }
}

__global__ void update_upper_by_out_buffer_m_obs1(int* out_buffer_m, int* count_out_m, int* hindex_in, int* hindex_out, int* core, int* newvisit){
...
__global__ void update_upper_by_out_buffer_l_obs1(int* out_buffer_l, int* count_out_l, int* hindex_in, int* hindex_out, int* core, int* newvisit){
...
__global__ void update_change_status_out_thread_obs1(int* out_buffer_s, int* count_out_s, int* hindex_in, int* hindex_out, int* core, int* out_adj, int* out_offset, int* core0, int k, int * global_done, int* newvisit, int* visit){
...
__global__ void update_change_status_in_thread_obs1(int* in_buffer_s, int* count_in_s, int* hindex_in, int* hindex_out, int* core, int* in_adj, int* in_offset, int* core0, int k, int * global_done,  int* newvisit, int* visit){
...
__global__ void update_change_status_out_warp_obs1(int* out_buffer_m, int* count_out_m, int* hindex_in, int* hindex_out, int* core, int* out_adj, int* out_offset, int* core0, int k, int * global_done,  int* newvisit, int* visit){
...
__global__ void update_change_status_in_warp_obs1(int* in_buffer_m, int* count_in_m, int* hindex_in, int* hindex_out, int* core, int* in_adj, int* in_offset, int* core0, int k, int * global_done,  int* newvisit, int* visit){
...
__global__ void update_change_status_out_block_obs1(int* out_buffer_l, int* count_out_l, int* hindex_in, int* hindex_out, int* core, int* out_adj, int* out_offset, int* core0, int k, int * global_done, int* newvisit, int* visit){
...
__global__ void update_change_status_in_block_obs1(int* in_buffer_l, int* count_in_l, int* hindex_in, int* hindex_out, int* core, int* in_adj, int* in_offset, int* core0, int k, int * global_done,  int* newvisit, int* visit){
...
__global__ void all_vertex_to_buffer(int num_vtx, int* global_buffer, int* buf_count, int* visit){
...
__global__ void vertex_to_buffer_by_out_degree_buffer_obs1(int* visit, int num_vtx, int k, int* core, int* out_degree, 
...
__global__ void vertex_to_buffer_by_in_degree_buffer_obs1(int* visit, int num_vtx, int k, int* core, int* in_degree, 
...
__global__ void hout_calculate_thread_buffer_obs1(int* out_buffer_s, int* count_out_s, int* upper, int* core0, int* hindex_out, int* out_adj, int* out_offset, int k, int* visit){
...
__global__ void hout_calculate_warp_buffer_obs1(int* out_buffer_m, int* count_out_m, int* upper, int* core0, int* hindex_out, int* out_adj, int* out_offset, int k, int* visit){
    ...
    while (true){
        ...
        while(true){
            ...
            int warp_total = warp_reduce_sum_balance_buffer_obs1(local_count);
...
__global__ void hout_calculate_block_buffer_obs1(int* out_buffer_l, int* count_out_l, int* upper, int* core0, int* hindex_out, int* out_adj, int* out_offset, int k, int* visit){
    ...
    for(int vid = blockIdx.x; vid < total; vid += gridDim.x){
        ...
        while(res >= 0){
            ...
            int warp_sum = warp_reduce_sum_balance_buffer_obs1(local_count);
...
__global__ void hin_calculate_thread_buffer_obs1(int* in_buffer_s, int* count_in_s, int* upper, int* core0, int* hindex_in, int* in_adj, int* in_offset, int k, int* hindex_out,int* visit){
...
__global__ void hin_calculate_warp_buffer_obs1(int* in_buffer_m, int* count_in_m, int* upper, int* core0, int* hindex_in, int* in_adj, int* in_offset, int k, int* hindex_out, int* visit){
    ...
    while (true){
        ...
        int v = t_global_buffer[start_prime]; // Get the vertex id
        if(visit[v] == 0 || hindex_out[v] == 0) continue; 
...
__global__ void hin_calculate_block_buffer_obs1(int* in_buffer_l, int* count_in_l, int* upper, int* core0, int* hindex_in, int* in_adj, int* in_offset, int k, int* hindex_out, int* visit){
...
__global__ void vertex_to_buffer_by_core0_buffer_obs1(int k, int* core0, int* in_degree, 
    int* in_buffer_s, int* in_buffer_m, int* in_buffer_l, 
    int* count_in_s, int* count_in_m, int* count_in_l, int* global_buffer, int* buf_count){
...
void klist_observation1(G_pointers &p){
    int iterationh = 0;
    int iterationk = 0;
    ...
    int* newvisit;
    cudaMalloc(&newvisit, sizeof(int) * p.num_vtx);
    ...
    while(pos < h_kstatus_v_len){
        ...
        if(pos == 0){
            ...
            all_vertex_to_buffer<<<BLK_NUMS, BLK_DIM>>>(p.num_vtx, global_buffer, buf_count, p.visit);
            ...
            while(done){
                ...
                vertex_to_buffer_by_out_degree_buffer_obs1<<<BLK_NUMS, BLK_DIM>>>(p.visit, p.num_vtx, k, p.core, p.out_deg, out_buffer_s, out_buffer_m, out_buffer_l, count_out_s, count_out_m, count_out_l, global_buffer, buf_count);
                vertex_to_buffer_by_in_degree_buffer_obs1<<<BLK_NUMS, BLK_DIM>>>(p.visit, p.num_vtx, k, p.core, p.in_deg, in_buffer_s, in_buffer_m, in_buffer_l, count_in_s, count_in_m, count_in_l, global_buffer, buf_count);

                // printf("I am 1002\n");
                hout_calculate_thread_buffer_obs1<<<BLK_NUMS, BLK_DIM>>>(out_buffer_s, count_out_s, p.core, core0, hindex_out, p.out_adj, p.out_offset, k, p.visit);
                hout_calculate_warp_buffer_obs1<<<BLK_NUMS, BLK_DIM>>>(out_buffer_m, count_out_m, p.core, core0, hindex_out, p.out_adj, p.out_offset, k, p.visit);
                hout_calculate_block_buffer_obs1<<<BLK_NUMS, BLK_DIM>>>(out_buffer_l, count_out_l, p.core, core0, hindex_out, p.out_adj, p.out_offset, k, p.visit);
                // printf("I am 1006\n");
                hin_calculate_thread_buffer_obs1<<<BLK_NUMS, BLK_DIM>>>(in_buffer_s, count_in_s, p.core, core0, hindex_in, p.in_adj, p.in_offset, k, hindex_out,  p.visit);
                hin_calculate_warp_buffer_obs1<<<BLK_NUMS, BLK_DIM>>>(in_buffer_m, count_in_m, p.core, core0, hindex_in, p.in_adj, p.in_offset, k, hindex_out,  p.visit);
                hin_calculate_block_buffer_obs1<<<BLK_NUMS, BLK_DIM>>>(in_buffer_l, count_in_l, p.core, core0, hindex_in, p.in_adj, p.in_offset, k, hindex_out,  p.visit);
    
                // printf("I am 1011\n");
                chkerr(cudaMemcpy(newvisit, p.visit, sizeof(int) * p.num_vtx, cudaMemcpyDeviceToDevice)); 
                chkerr(cudaMemset(p.visit, 0, sizeof(int) * p.num_vtx));


                update_change_status_out_thread_obs1<<<BLK_NUMS, BLK_DIM>>>(out_buffer_s, count_out_s, hindex_in, hindex_out, p.core, p.out_adj, p.out_offset, core0, k, global_done, newvisit, p.visit);
                update_change_status_out_warp_obs1<<<BLK_NUMS, BLK_DIM>>>(out_buffer_m, count_out_m, hindex_in, hindex_out, p.core, p.out_adj, p.out_offset, core0, k, global_done, newvisit, p.visit);
                update_change_status_out_block_obs1<<<BLK_NUMS, BLK_DIM>>>(out_buffer_l, count_out_l, hindex_in, hindex_out, p.core, p.out_adj, p.out_offset, core0, k, global_done, newvisit, p.visit);
                // printf("I am 1019\n");
                update_change_status_in_thread_obs1<<<BLK_NUMS, BLK_DIM>>>(in_buffer_s, count_in_s, hindex_in, hindex_out, p.core, p.in_adj, p.in_offset, core0, k, global_done, newvisit, p.visit);
                update_change_status_in_warp_obs1<<<BLK_NUMS, BLK_DIM>>>(in_buffer_m, count_in_m, hindex_in, hindex_out, p.core, p.in_adj, p.in_offset, core0, k, global_done, newvisit, p.visit);
                update_change_status_in_block_obs1<<<BLK_NUMS, BLK_DIM>>>(in_buffer_l, count_in_l, hindex_in, hindex_out, p.core, p.in_adj, p.in_offset, core0, k, global_done, newvisit, p.visit);
                // printf("I am 1023\n");
                update_upper_by_out_buffer_s_obs1<<<BLK_NUMS, BLK_DIM>>>(out_buffer_s, count_out_s, hindex_in, hindex_out, p.core, newvisit);
                update_upper_by_out_buffer_m_obs1<<<BLK_NUMS, BLK_DIM>>>(out_buffer_m, count_out_m, hindex_in, hindex_out, p.core, newvisit);
                update_upper_by_out_buffer_l_obs1<<<BLK_NUMS, BLK_DIM>>>(out_buffer_l, count_out_l, hindex_in, hindex_out, p.core, newvisit);
        ...
        if(pos + 1 < h_kstatus_v_len && h_kstatus_v[pos+1] != k+1){
            ...
            vertex_to_buffer_by_core0_buffer_obs1<<<BLK_NUMS, BLK_DIM>>>(k, core0, p.in_deg, in_buffer_s, in_buffer_m, in_buffer_l, count_in_s, count_in_m, count_in_l, global_buffer, buf_count);
