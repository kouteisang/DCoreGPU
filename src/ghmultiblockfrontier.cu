#include "ghmultiblockfrontier.cuh"
#include "gpuutilis.cuh"


__device__ int warp_reduce_sum_balance_buffer_mb(int val) {
...
__global__ void vertex_to_buffer_buffer_multi_block(int num_vtx, int* global_buffer, int* buf_count, int* visit){
...
__global__ void vertex_to_buffer_by_out_degree_buffer_multi_block(int* visit, int num_vtx, int k, int* core, int* out_degree, 
...
__global__ void vertex_to_buffer_by_in_degree_buffer_multi_block(int* visit, int num_vtx, int k, int* core, int* in_degree, 
...
__global__ void hout_calculate_thread_buffer_multi_block(int* out_buffer_s, int* count_out_s, int* upper, int* core0, int* hindex_out, int* out_adj, int* out_offset, int k){
...
__global__ void hout_calculate_warp_buffer_multi_block(int* out_buffer_m, int* count_out_m, int* upper, int* core0, int* hindex_out, int* out_adj, int* out_offset, int k){
    ...
    while (true){
        ...
        while(true){
            ...
            int warp_total = warp_reduce_sum_balance_buffer_mb(local_count);
...
__global__ void hout_calculate_block_buffer_multi_block(int* out_buffer_l, int* count_out_l, int* upper, int* core0, int* hindex_out, int* out_adj, int* out_offset, int k){
    ...
    for(int vid = 0; vid < end; vid ++){
        ...
        while(res >= 0){
            ...
            int warp_sum = warp_reduce_sum_balance_buffer_mb(local_count);
...
__global__ void hin_calculate_thread_buffer_multi_block(int* in_buffer_s, int* count_in_s, int* upper, int* core0, int* hindex_in, int* in_adj, int* in_offset, int k, int* hindex_out){
...
__global__ void hin_calculate_warp_buffer_multi_block(int* in_buffer_m, int* count_in_m, int* upper, int* core0, int* hindex_in, int* in_adj, int* in_offset, int k, int* hindex_out){
...
__global__ void hin_calculate_block_buffer_multi_block(int* in_buffer_l, int* count_in_l, int* upper, int* core0, int* hindex_in, int* in_adj, int* in_offset, int k, int* hindex_out){
...
__global__ void update_change_status_out_thread_multi_block(int* out_buffer_s, int* count_out_s, int* hindex_in, int* hindex_out, int* core, int* out_adj, int* out_offset, int* core0, int k, int * global_done, int* visit){
...
__global__ void update_change_status_out_warp_multi_block(int* out_buffer_m, int* count_out_m, int* hindex_in, int* hindex_out, int* core, int* out_adj, int* out_offset, int* core0, int k, int * global_done, int* visit){
...
__global__ void update_change_status_out_block_multi_block(int* out_buffer_l, int* count_out_l, int* hindex_in, int* hindex_out, int* core, int* out_adj, int* out_offset, int* core0, int k, int * global_done, int* visit){
...
__global__ void update_change_status_in_thread_multi_block(int* in_buffer_s, int* count_in_s, int* hindex_in, int* hindex_out, int* core, int* in_adj, int* in_offset, int* core0, int k, int * global_done, int* visit){
...
__global__ void update_change_status_in_warp_multi_block(int* in_buffer_m, int* count_in_m, int* hindex_in, int* hindex_out, int* core, int* in_adj, int* in_offset, int* core0, int k, int * global_done, int* visit){
...
__global__ void update_change_status_in_block_multi_block(int* in_buffer_l, int* count_in_l, int* hindex_in, int* hindex_out, int* core, int* in_adj, int* in_offset, int* core0, int k, int * global_done, int* visit){
...
__global__ void update_upper_by_out_buffer_s_multi_block(int* out_buffer_s, int* count_out_s, int* hindex_in, int* hindex_out, int* core){
    __shared__ int end;
    __shared__ int* t_global_buffer;
...
__global__ void update_upper_by_out_buffer_m_multi_block(int* out_buffer_m, int* count_out_m, int* hindex_in, int* hindex_out, int* core){
...
__global__ void update_upper_by_out_buffer_l_multi_block(int* out_buffer_l, int* count_out_l, int* hindex_in, int* hindex_out, int* core){
...
__global__ void vertex_to_buffer_by_core0_buffer_multi_block(int k, int* core0, int* in_degree, 
    int* in_buffer_s, int* in_buffer_m, int* in_buffer_l, 
    int* count_in_s, int* count_in_m, int* count_in_l, int* global_buffer, int* buf_count){
...
__global__ void hin_count_thread_buffer_multi_block(int* in_count_num, int* in_buffer_s, int* count_in_s, int* core, int* core0, int* in_adj, int* in_offset, int k){
...
__global__ void hin_count_warp_buffer_multi_block(int* in_count_num, int* in_buffer_m, int* count_in_m, int* core, int* core0, int* in_adj, int* in_offset, int k){
...
__global__ void hin_count_block_buffer_multi_block(int* in_count_num, int* in_buffer_l, int* count_in_l, int* core, int* core0, int* in_adj, int* in_offset, int k){
...
void ghmultiblockfrontier_decomposition(G_pointers &p, int t){
    ...
    while(pos < h_kstatus_v_len){
        ...
        if(pos <= 0){
            ...
            vertex_to_buffer_buffer_multi_block<<<BLK_NUMS, BLK_DIM>>>(p.num_vtx, global_buffer, buf_count, p.visit);
            ...
            while(done){
                ...
                vertex_to_buffer_by_out_degree_buffer_multi_block<<<BLK_NUMS, BLK_DIM>>>(p.visit, p.num_vtx, k, p.core, p.out_deg, out_buffer_s, out_buffer_m, out_buffer_l, count_out_s, count_out_m, count_out_l, global_buffer, buf_count);
                vertex_to_buffer_by_in_degree_buffer_multi_block<<<BLK_NUMS, BLK_DIM>>>(p.visit, p.num_vtx, k, p.core, p.in_deg, in_buffer_s, in_buffer_m, in_buffer_l, count_in_s, count_in_m, count_in_l, global_buffer, buf_count);

                hout_calculate_thread_buffer_multi_block<<<BLK_NUMS, BLK_DIM>>>(out_buffer_s, count_out_s, p.core, core0, hindex_out, p.out_adj, p.out_offset, k);
                hout_calculate_warp_buffer_multi_block<<<BLK_NUMS, BLK_DIM>>>(out_buffer_m, count_out_m, p.core, core0, hindex_out, p.out_adj, p.out_offset, k);
                hout_calculate_block_buffer_multi_block<<<BLK_NUMS, BLK_DIM>>>(out_buffer_l, count_out_l, p.core, core0, hindex_out, p.out_adj, p.out_offset, k);
                
                hin_calculate_thread_buffer_multi_block<<<BLK_NUMS, BLK_DIM>>>(in_buffer_s, count_in_s, p.core, core0, hindex_in, p.in_adj, p.in_offset, k, hindex_out);
                hin_calculate_warp_buffer_multi_block<<<BLK_NUMS, BLK_DIM>>>(in_buffer_m, count_in_m, p.core, core0, hindex_in, p.in_adj, p.in_offset, k, hindex_out);
                hin_calculate_block_buffer_multi_block<<<BLK_NUMS, BLK_DIM>>>(in_buffer_l, count_in_l, p.core, core0, hindex_in, p.in_adj, p.in_offset, k, hindex_out);
    
                cudaMemset(p.visit, 0, sizeof(int) * p.num_vtx);
                
                
                update_change_status_out_thread_multi_block<<<BLK_NUMS, BLK_DIM>>>(out_buffer_s, count_out_s, hindex_in, hindex_out, p.core, p.out_adj, p.out_offset, core0, k, global_done, p.visit);
                update_change_status_out_warp_multi_block<<<BLK_NUMS, BLK_DIM>>>(out_buffer_m, count_out_m, hindex_in, hindex_out, p.core, p.out_adj, p.out_offset, core0, k, global_done, p.visit);
                update_change_status_out_block_multi_block<<<BLK_NUMS, BLK_DIM>>>(out_buffer_l, count_out_l, hindex_in, hindex_out, p.core, p.out_adj, p.out_offset, core0, k, global_done, p.visit);

                update_change_status_in_thread_multi_block<<<BLK_NUMS, BLK_DIM>>>(in_buffer_s, count_in_s, hindex_in, hindex_out, p.core, p.in_adj, p.in_offset, core0, k, global_done, p.visit);
                update_change_status_in_warp_multi_block<<<BLK_NUMS, BLK_DIM>>>(in_buffer_m, count_in_m, hindex_in, hindex_out, p.core, p.in_adj, p.in_offset, core0, k, global_done, p.visit);
                update_change_status_in_block_multi_block<<<BLK_NUMS, BLK_DIM>>>(in_buffer_l, count_in_l, hindex_in, hindex_out, p.core, p.in_adj, p.in_offset, core0, k, global_done, p.visit);
                

                update_upper_by_out_buffer_s_multi_block<<<BLK_NUMS, BLK_DIM>>>(out_buffer_s, count_out_s, hindex_in, hindex_out, p.core);
                update_upper_by_out_buffer_m_multi_block<<<BLK_NUMS, BLK_DIM>>>(out_buffer_m, count_out_m, hindex_in, hindex_out, p.core);
                update_upper_by_out_buffer_l_multi_block<<<BLK_NUMS, BLK_DIM>>>(out_buffer_l, count_out_l, hindex_in, hindex_out, p.core);
        ...
        if(pos + 1 < h_kstatus_v_len && h_kstatus_v[pos+1] != k+1){
            ...
            vertex_to_buffer_by_core0_buffer_multi_block<<<BLK_NUMS, BLK_DIM>>>(k, core0, p.in_deg, in_buffer_s, in_buffer_m, in_buffer_l, count_in_s, count_in_m, count_in_l, global_buffer, buf_count);

            hin_count_thread_buffer_multi_block<<<BLK_NUMS, BLK_DIM>>>(p.in_count_num, in_buffer_s, count_in_s, p.core, core0, p.in_adj, p.in_offset, k);
            hin_count_warp_buffer_multi_block<<<BLK_NUMS, BLK_DIM>>>(p.in_count_num, in_buffer_m, count_in_m, p.core, core0, p.in_adj, p.in_offset, k);
            hin_count_block_buffer_multi_block<<<BLK_NUMS, BLK_DIM>>>(p.in_count_num, in_buffer_l, count_in_l, p.core, core0, p.in_adj, p.in_offset, k);
